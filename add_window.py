...
class AddWindow(QDialog):
    ...
    def on_okButton_click(self):
        answer = self.parent.service.post(self.textEdit.toPlainText(), self.textEdit_2.toPlainText())
        if answer == 0:
            self.parent.update_table()
            self.hide()
            self.msg.setText("The line was added successfully!")
            self.msg.exec_()
        else:
    ...
    def retranslateUi(self):
        ...
        self.label.setText(_translate("Dialog", "Enter the author:"))
        self.label_2.setText(_translate("Dialog", "Enter the quote:"))
